...
from .views import (EBFormAPIView, IGMUNRegistrationAPIView,
                    PreCARegistrationAPIView, PreRegistrationFormAPIView)
...
urlpatterns = [
    ...
    path('register/', IGMUNRegistrationAPIView.as_view())
]
