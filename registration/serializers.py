...
class UserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            "main_pronite", "flagship", "aayaam", "antarang", "nrityansh", "cob", "igmun_pref", "mun_exp", "qr_code",
            "pronites_qr", "attendance_day1", "attendance_day2", "attendance_day3", "attendance_day4", "events", "is_gold"
        ]
